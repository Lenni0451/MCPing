...
class BedrockRaknetPingResponseTest {

    @Test
    void testNull() {
        BedrockRaknetPingResponse response = new BedrockRaknetPingResponse();
    ...
    void testUnimplemented(final BedrockRaknetPingResponse response) {
